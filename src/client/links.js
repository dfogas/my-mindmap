const links = {
  ...
  cpu_operation: ['instruction', 'control_flow', 'bitwise_operation'],
  ...
  cpu_operation: ['cpu', 'control_unit', 'ISA'],
  ...
  domain: ['complexity', 'domain_model', 'making_examples'],
  ...
  electrical_components: ['electronics'],
  ...
  examples_pl: ['programming_language', 'c_programming_language', 'javascript'],
  ...
  function: ['value', 'set', 'programming', 'side_effect'],
  functional_programming: ['function', 'programming_paradigm', 'imperative_programming', 'declarative_paradigm'],
  ...
  imperative_programming: ['declarative_paradigm'],
  ...
  logic: ['philosophy', 'reason', 'combinational_logic', 'sequential_logic'],
  ...
  mathematics: ['arithmetics', 'quantity', 'change', 'geometry', 'algebra', 'mathematical_analysis', 'knowledge'],
  ...
  programming_language: ['constructed_language', 'data_type', 'computer', 'examples_pl'],
  ...
  RAM: ['computer_memory'],
  science: ['reality', 'observer', 'religion', 'empirical_evidence', 'knowledge'],
  ...
  structured_programming: ['programming_paradigm', 'object_oriented_programming'],
