const links = {
  ...
  application: ['software', 'distributed_application'],
  ...
  computer_network: ['computer', 'telecommunications', 'internet'],
  ...
  index: ['distributed_system', 'software_development', 'automation', 'paradigm'],
  ...
  server: ['index', 'client', 'p2p_network'],
  ...
  stream: ['sequence', 'data', 'batch_program'],
