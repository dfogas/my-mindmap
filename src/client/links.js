...
const links = {
  ...
  datagram: ['IP', 'packet_switching', 'packet'],
  ...
  device: ['tool', 'computer', 'control_system'],
  ...
  HTTP: ['WWW', 'http_request', 'http_response'],
  ...
  lambda_calculus: ['combinatory_logic', 'lambda', 'substitution'],
  ...
  mathematical_logic: ['set_theory', 'logic', 'computer_science'],
  ...
  programming: ['execution', 'computer_program', 'computation', 'PLT'],
  ...
  WWW: ['HTTP', 'URI', 'hyperlink', 'internet', 'HTTP', 'AJAX', 'web_application'],
